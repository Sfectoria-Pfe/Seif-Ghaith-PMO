...
export const getorderreparations = createAsyncThunk("getorderreparations", async () => {
    try {
  ...
  export const getorderreparation = createAsyncThunk("getorderreparation", async (id) => {
    try {
  ...
  export const updateorderreparation = createAsyncThunk("updateorderreparation", async (args) => {
    const {id,body} = args
    try {
  ...
  export const addorderreparation = createAsyncThunk("addorderreparation", async (body) => {
    try {
  ...
  export const deleteorderreparation = createAsyncThunk("deleteorderreparation",  async (id) => {
    try {
